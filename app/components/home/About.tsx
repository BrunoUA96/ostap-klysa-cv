...
export const About = () => (
  <motion.h3
    ...
    <span className="bg-white text-black px-2">Working</span> on wide range of
    project types, from landing pages to large platforms.{" "}
    <span className="bg-white text-black px-2">Fast</span> adaptation to new
    Technologies, Frameworks and Program Languages.{" "}
